...
class UpdateData : AppCompatActivity() {
    ...
    private lateinit var new_nim: TextView
    private lateinit var new_nama: TextView
    private lateinit var new_jurusan: TextView
        ...
        update.setOnClickListener(object : View.OnClickListener {
            override fun onClick(v: View?) {
                ...
                if (isEmpty(cekNIM!!) || isEmpty(cekNama!!) || isEmpty(cekJurusan!!)) {
                    Toast.makeText(
                        this@UpdateData, "Data tidak boleh ada yang kosong", Toast.LENGTH_SHORT
                    ).show()
                } else {
